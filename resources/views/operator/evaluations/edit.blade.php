                            ...
                            <div class="mb-4">
                                    ...
                                    @for($i = 1; $i <= 5; $i++)
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" 
                                                ...
                                                value="{{ $i }}" 
                                                {{ $jobseeker->evaluations->where('evaluation_axis_id', $axis->id)->first()?->score == $i ? 'checked' : '' }}
                                                required>
                                ...
                                <div class="mt-2">
                                    ...
                                    <textarea class="form-control" 
                                        ...
                                        rows="2"
                                        maxlength="1000">{{ $jobseeker->evaluations->where('evaluation_axis_id', $axis->id)->first()?->comment }}</textarea>
                                </div>
                            </div>
                        @endforeach
