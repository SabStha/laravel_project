        ...
        <div class="col-md-8">
            <div class="card shadow-lg rounded-3">
                <div class="card-header text-center bg-primary text-white py-4">
                    <h3>{{ __('求職者登録') }}</h3> <!-- Jobseeker Registration -->
                    <p class="lead">サインアップして、日本中の求人情報を探しましょう！</p> <!-- Sign up and explore job opportunities across Japan! -->
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="text-center mt-4">
                        <p>アカウントをお持ちですか？ <a href="{{ route('login') }}" class="text-primary">こちらからログイン</a></p> <!-- Already have an account? Login here -->
                    </div>
                </div>
            </div>
        </div>
